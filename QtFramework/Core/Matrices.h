...
namespace cagd
{
    ...
    //--------------------------------------------------
    template <typename T>
    Matrix<T> :: Matrix(GLuint row_count, GLuint column_count) : _row_count(row_count), _column_count(column_count), _data(_row_count, std::vector<T>(column_count))
    {
    }
    ...
    // get element by reference
    template <typename T>
    T& Matrix<T>::operator ()(GLuint row, GLuint column) { return _data[row][column]; }

    // get copy of an element
    template <typename T>
    T Matrix<T>::operator ()(GLuint row, GLuint column) const { return _data[row][column]; }

    // get dimensions
    template <typename T>
    GLuint Matrix<T>::GetRowCount() const { return _row_count; }

    template <typename T>
    GLuint Matrix<T>::GetColumnCount() const { return _column_count; }
    ...
    // get element by reference
    template <typename T>
    T& RowMatrix<T>::operator ()(GLuint column) { return this->_data[0][column]; }
    ...
    // get copy of an element
    template <typename T>
    T RowMatrix<T>::operator ()(GLuint column) const { return this->_data[0][column]; }
    ...
    // get element by reference
    template <typename T>
    T& ColumnMatrix<T>::operator ()(GLuint row) { return this->_data[row][0]; }
    ...
    // get copy of an element
    template <typename T>
    T ColumnMatrix<T>::operator ()(GLuint row) const { return this->_data[row][0]; }
    ...
    // get dimension
    template <typename T>
    GLuint TriangularMatrix<T>::GetRowCount() const { return _row_count; }

    // get element by reference
    template <typename T>
    T& TriangularMatrix<T>::operator ()(GLuint row, GLuint column) { return _data[row][column]; }

    // get copy of an element
    template <typename T>
    T TriangularMatrix<T>::operator ()(GLuint row, GLuint column) const { return _data[row][column]; }
    ...
    std::istream& operator >>(std::istream& lhs, Matrix<T>& rhs)
    {
        ...
        rhs._data.reserve(rhs._row_count);
